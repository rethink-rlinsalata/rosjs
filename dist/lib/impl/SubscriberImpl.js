  ...
  _createClass(SubscriberImpl, [{
    ...
    value: function _handleConnectionHeader(client, msg) {
      ...
      client.on('close', function () {
        _this7._log.warn('Pub %s closed on topic %s', client.name, _this7.getTopic());
        _this7._log.warn('Subscriber ' + _this7.getTopic() + ' client ' + client.name + ' disconnected!');
        _this7._disconnectClient(client.nodeUri);
      });
    }
